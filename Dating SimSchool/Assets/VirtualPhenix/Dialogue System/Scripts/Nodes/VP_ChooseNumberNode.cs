...
namespace VirtualPhenix.Dialog
{
    ...
    public class VP_ChooseNumberNode : VP_DialogBaseNode
    {
        ...
        {
            VP_DialogManager.ChooseNumberWithParamsInGraph(m_message, new Vector3(m_min, m_max, m_number), WaitForInput, m_canCancel, CancelledInput, m_dialogType, m_translate, m_positionData);
        }

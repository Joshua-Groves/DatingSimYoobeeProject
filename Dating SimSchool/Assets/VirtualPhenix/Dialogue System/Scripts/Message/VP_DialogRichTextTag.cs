                    ...
                    if (parsedTag != null && parsedTag.TagType == tagType)
                    {
                        ...
                        if (parsedTag.TagType == VP_DialogSetup.Tags.VARIABLE)
                        {
                            ...
                            if (!string.IsNullOrEmpty(middleText) && !string.IsNullOrEmpty(parsedTag.Parameter))
                            {
                                ...
                                {
                                    variable = VP_DialogManager.Instance.GetVariable(varName, true);
                                }
                                else if (middleText == "int" || middleText == "Int" || middleText == "integer" || middleText == "Integer")
                                {
                                    variable = VP_DialogManager.Instance.GetVariable(varName, 0);
                                }
                                else if (middleText == "float" || middleText == "Float")
                                {
                                    variable = VP_DialogManager.Instance.GetVariable(varName, 0f);
                                }
                                else if (middleText == "double" || middleText == "Double")
                                {
                                    variable = VP_DialogManager.Instance.GetVariable(varName, 0.0);
                                }
                                else if (middleText == "string" || middleText == "String" || middleText == "str" || middleText == "Str")
                                {
                                    variable = VP_DialogManager.Instance.GetVariable(varName, "");
                                }
                                else if (middleText == "object" || middleText == "Object" || middleText == "unityobject" || middleText == "UnityObject")
                                {
                                    variable = VP_DialogManager.Instance.GetVariable(varName, new UnityEngine.Object());
                                }
                                else if (middleText == "gameobject" || middleText == "Gameobject" || middleText == "gameObject" || middleText == "GameObject")
                                {
                                    variable = VP_DialogManager.Instance.GetVariable(varName, new UnityEngine.GameObject());
                                }
                                string m_variableT;
                                if (variable != null)
                                {
                        ...
                        else if (parsedTag.TagType == VP_DialogSetup.Tags.GRAPH_VARIABLE)
                        {
                            ...
                            if (!string.IsNullOrEmpty(parsedTag.Parameter))
                            {
                                if (middleText == "bool" || middleText == "Bool" || middleText == "boolean" || middleText == "Boolean")
                                {
                                    variable = VP_DialogManager.Instance.GetGraphVariable(varName, true);
                                }
                                else if (middleText == "int" || middleText == "Int" || middleText == "integer" || middleText == "Integer")
                                {
                                    variable = VP_DialogManager.Instance.GetGraphVariable(varName, 0);
                                }
                                else if (middleText == "float" || middleText == "Float")
                                {
                                    variable = VP_DialogManager.Instance.GetGraphVariable(varName, 0f);
                                }
                                else if (middleText == "double" || middleText == "Double")
                                {
                                    variable = VP_DialogManager.Instance.GetGraphVariable(varName, 0.0);
                                }
                                else if (middleText == "string" || middleText == "String" || middleText == "str" || middleText == "Str")
                                {
                                    variable = VP_DialogManager.Instance.GetGraphVariable(varName, "");
                                }
                                else if (middleText == "object" || middleText == "Object" || middleText == "unityobject" || middleText == "UnityObject")
                                {
                                    variable = VP_DialogManager.Instance.GetGraphVariable(varName, new UnityEngine.Object());
                                }
                                else if (middleText == "gameobject" || middleText == "Gameobject" || middleText == "gameObject" || middleText == "GameObject")
                                {
                                    variable = VP_DialogManager.Instance.GetGraphVariable(varName, new UnityEngine.GameObject());
                                }
                                string m_variableT;
                                if (variable != null)
                                {

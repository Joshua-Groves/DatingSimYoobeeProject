...
{
    public class VP_DialogMessage : MonoBehaviour
    {
        #region enums
        ...
        /// </summary>
        protected VP_DialogMessageData m_dialogData;
        /// <summary>
        ...
        /// </summary>
        [SerializeField] protected bool m_listenDefaultInputCallbacks = true;
        /// <summary>
        ...
        /// </summary>
        [SerializeField] protected List<VP_DialogTextAnimation> m_animations;
        ...
        [Header("Dialog Audios"), Space]
        /// <summary>
        /// If you have sounds per letter (different), we store them here
        /// </summary>
        protected List<AudioClip> m_letterSounds;
        /// <summary>
        /// Sound played when we change the text
        /// </summary>
        [SerializeField] protected AudioClip m_continueAudio;
        /// <summary>
        /// Current sound played every character
        /// </summary>
        [SerializeField] protected AudioClip m_characterAudio;
        /// <summary>
        ...
        /// </summary>
        protected bool m_useAudioManager;
        /// <summary>
        ...
        DIALOG_VOICE_TYPE voiceType = DIALOG_VOICE_TYPE.NO_SOUND;
        ...
        public RectTransform MainTextRect { get { return m_mainText.rectTransform; } }
        public RectTransform BGRect { get { return m_bg.rectTransform; } }
        public GameObject OptionGroup { get { return m_optionGroup; } }
        ...
        private void OnEnable()
        {
            ...
            if (m_letterSounds == null)
                m_letterSounds = new List<AudioClip>();
        ...
        void Start()
        {
            ...
            m_useAudioManager = VP_AudioManager.Instance != null;
        ...
        public void CheckDownAnswerIndex()
        {
            if (m_state == TEXT_STATE.SHOWN)
            {
                if (m_numberOfAnswers > 0)
        ...
        public void CheckUpAnswerIndex()
        {
            if (m_state == TEXT_STATE.SHOWN)
            {
                if (m_numberOfAnswers > 0)
        ...
        public float AutoAnswerTimeProgress ()
        {
            return m_spentAutoTime / m_autoTimeToAnswer;
        }

        void StartAutoAnswerTimer()
        {
            StopAutoAnswerTimer();
        ...
        IEnumerator WaitForAutoAnswer(float _timeToAnswer)
        {
            m_spentAutoTime = 0f;
        ...
        {
            if (m_listenDefaultInputCallbacks)
            {
        ...
        void OnExternalAnswer(int _answerIndex)
        {
        ...
        public void Skip()
        {
            ...
            m_iconForNext.gameObject.SetActive(false);
            VP_DialogManager.Instance.ContinueText();
        }
        ...
        IEnumerator WaitForAnswerAudioEnd(float _time, System.Action _callback)
        {
            float timer = 0f;
        ...
        public void Answer(int index)
        {
            ...
            if (answerclip != null)
            {
                ...
                {
                    StartCoroutine(WaitForAnswerAudioEnd(answerclip.length, () =>
                    {
        ...
        public void ChooseNumber(int _number)
        {
            m_playSoundOnContinue = m_dialogData.m_soundOnContinue;
        ...
        public void DirectMessage(string _msg)
        {
            m_mainText.text = _msg;
            StartShowingCharacters(0.1f);
        }

        void SetGraphicsAlpha(float _alpha)
        {
            if (m_dialogCanvasGroup)
        ...
        void ChangeEventSystemHandlingObject()
        {
        ...
        public void ShowDialog(VP_DialogMessageData _newData)
        {
            StopAllCoroutines();
            ...
            {
                m_hasAnimations = (m_characterData.animator != null && !string.IsNullOrEmpty(m_characterData.speakingAnim));
                ...
                if (m_characterData.m_overrideFontSize)
                ...
                string charaName = m_characterData.characterName;
                ...
                if (m_characterData.m_dialogVoiceType == DIALOG_VOICE_TYPE.SOUND_EVERY_CHARACTER_DIFFERENT_SOUND)
                {
                    ParseAlphabetSounds(m_characterData);
                }
                else if (m_characterData.m_dialogVoiceType == DIALOG_VOICE_TYPE.SOUND_VOCALS)
                {
                    ParseVocalSounds(m_characterData);
                }
            }
            else
            {
            ...
            if (positionData != null)
            {
                if (m_setPositionData)
                {
                    ...
                    {
                        VP_Utils.SetRectValues(m_bg.rectTransform, positionData.m_bgLeftRight, positionData.m_bgTopBottom);
                    }
                ...
                switch (_newData.m_dialogType)
                {
                    case DIALOG_TYPE.MUGSHOT:
                        ...
                        if (m_setPositionData && positionData && positionData.m_setTextPosition)
                            VP_Utils.SetRectValues(m_mainText.rectTransform, positionData.m_textLeftRightMugshot, positionData.m_textTopBottomMugshot);
                        break;
                    ...
                    case DIALOG_TYPE.REGULAR:
                        ...
                        m_bg.gameObject.SetActive(true);
                        if (m_setPositionData && positionData && positionData.m_setTextPosition)
                            VP_Utils.SetRectValues(m_mainText.rectTransform, positionData.m_textLeftRightRegular, positionData.m_textTopBottomRegular);
                        break;
            ...
            else
            {
                ...
                {
                    if (m_dialogRect)
                        VP_Utils.SetRectValues(m_dialogRect, Vector2.zero, Vector2.zero);
                    else
            ...
            if (m_changeBg)
            {
                if (_newData.m_dialogType != DIALOG_TYPE.NONE)
                    m_bg.sprite = m_backgrounds[_newData.m_dialogType];
            }

            m_textToShow = _newData.m_text;

            m_showingText = m_textToShow;
#if USE_VIRTUAL_PHENIX_DIALOGUE_SYSTEM
	    ...
	    public void DoFade(Graphic _graphicToFade, float _origin, float _end, float _duration = 1f, System.Action _callback = null)
	    {
	    ...
	    /// <returns></returns>
	    IEnumerator DoFadeCoroutine(Graphic _graphicToFade, float _origin, float _end, float _duration = 1f, System.Action _callback = null)
	    {
	    	float alpha = _origin;
        ...
        public void DoFade(CanvasGroup _canvasGroup, float _origin, float _end, float _duration = 1f, System.Action _callback = null)
        {
        ...
        /// <param name="_graphicToFade"></param>
        /// <returns></returns>
        IEnumerator DoFadeCoroutine(CanvasGroup _canvasGroup, float _origin, float _end, float _duration = 1f, System.Action _callback = null)
        {
            float alpha = _origin;
            float normalizedTime = _origin;
        ...
        void ParseAlphabetSounds(VP_DialogCharacterData characterData)
        {
            m_letterSounds.Clear();
            AudioClip[] letterInArray = Resources.LoadAll<AudioClip>("Dialogue/Audio/Letters/" + VP_LocalizationManager.GetCurrentLanguage().ToString().ToUpper() + "_" + characterData.gender.ToString());

            m_letterSounds = (letterInArray != null) ? new List<AudioClip>(letterInArray) : new List<AudioClip>();
        }

        void ParseVocalSounds(VP_DialogCharacterData characterData)
        {
            m_letterSounds.Clear();
            AudioClip[] letterInArray = Resources.LoadAll<AudioClip>("Dialogue/Audio/Letters/" + VP_LocalizationManager.GetCurrentLanguage().ToString().ToUpper() + "_" + characterData.gender.ToString());

            m_letterSounds = (letterInArray != null && letterInArray.Length > 21) ? new List<AudioClip>() { letterInArray[0], letterInArray[4], letterInArray[8], letterInArray[14], letterInArray[20] } : new List<AudioClip>();
        }
        /// <summary>
        ...
        void EndDirectly()
        {
            ...
            if (m_dialogData.m_clipDialogue != null)
            {
                ...
                {
                    m_source.clip = m_dialogData.m_clipDialogue;
                    m_source.Play();
                }
            }
        ...
        IEnumerator GenericWait(float _time = 2f, System.Action _callback = null)
        {
            float timer = 0f;
            while(timer < _time)
            {
        ...
        /// </summary>
        public void StartFadeOut(bool _nextText = true)
        {
        ...
        public void StartShowingCharacters(float _timeBetweenChars = 0.1f)
        {
#if DOTWEEN
            if (m_dialogAnimation == ANIMATION_TYPE.TWEEN)
            {
            ...
            else
            {
                ...
                {
                    m_displayCoroutine = StartCoroutine(DisplayTextByChars(_timeBetweenChars, VP_Utils.DialogUtils.RemoveCustomTags(m_mainText.text)));
                }
#else
                m_displayCoroutine = StartCoroutine(DisplayTextByChars(_timeBetweenChars, VP_Utils.DialogUtils.RemoveCustomTags(m_mainText.text)));
#endif
        ...
        /// <returns></returns>
        int GetIndexOfLetterInAlphabet(char _chara)
        {
            string charaStr = _chara.ToString().ToUpper();

            ALPHABET letterAlphabet = ALPHABET.SPECIAL_CHARACTER;
        ...
        /// <param name="_chara"></param>
        /// <returns></returns>
        int GetIndexOfLetterInVocal(char _chara)
        {
            string charaStr = _chara.ToString().ToUpper();

            VOCALS letterVocal = VOCALS.SPECIAL_CHARACTER;

            System.Enum.TryParse<VOCALS>(charaStr, out letterVocal);
            int index = (int)(letterVocal);
            //VP_Debug.Log("Index = " + index);
            return index;
        }
        /// <summary>
        ...
        /// <returns></returns>
        IEnumerator DisplayTextByChars(float timeBetweenChars, string taglessText)
        {
            ...
            if (m_characterData != null)
            {
                voiceType = m_characterData.m_dialogVoiceType;
            }
            else
            {
                voiceType = m_clip != null ? DIALOG_VOICE_TYPE.SOUND_EVERY_CHARACTER : DIALOG_VOICE_TYPE.NO_SOUND;
            }

            bool m_hasEmotions = m_emotionList.Count > 0;
            int blankSpaces = 0;
            
            while (m_currPrintedChars < m_textCharacters || m_needLastDisplay)
            {
                if (m_refreshAnimations)
                    this.UpdateMeshAndAnims();
                ...
                if (!m_waitingForInputToContinueSameDialog)
                {
                    ...
                    if (voiceType == DIALOG_VOICE_TYPE.SOUND_EVERY_CHARACTER && m_clip != null)
                    {
                        if (characters[m_currPrintedChars] != ' ')
                            m_letterSource.PlayOneShot(m_clip);
                    }
                    else if (voiceType == DIALOG_VOICE_TYPE.SOUND_EVERY_CHARACTER_DIFFERENT_SOUND && m_letterSounds.Count > 0)
                    {
                        int soundIndex = GetIndexOfLetterInAlphabet(characters[m_currPrintedChars]);
                        if (soundIndex < alphabetLength && soundIndex > 0)
                            m_letterSource.PlayOneShot(m_letterSounds[soundIndex]);
                    }
                    else if (voiceType == DIALOG_VOICE_TYPE.SOUND_VOCALS && m_letterSounds.Count > 0)
                    {
                        int soundIndex = GetIndexOfLetterInVocal(characters[m_currPrintedChars]);
                        if (soundIndex < 6 && soundIndex > 0)
                            m_letterSource.PlayOneShot(m_letterSounds[soundIndex]);
                    }
                    else if (voiceType == DIALOG_VOICE_TYPE.SOUND_EVERY_WORD && m_clip != null)
                    {
                        if (characters[m_currPrintedChars] == ' ')
                            m_letterSource.PlayOneShot(m_clip);
                    }
        ...
        /// <returns></returns>
        IEnumerator WaitForNextTextAutomatic(float _time = 2f)
        {
            float timer = 0f;
        ...
        IEnumerator AutomaticSubDialog(float _time = 2f)
        {
            float timer = 0f;
        ...
        private void ProcessCustomTags(string _noTagText)
        {
#if USE_TEXT_ANIMATOR
            if (m_useTextAnimator)
                return;
...
#else
            var textAsSymbolList = new List<VP_DialogTextSymbol>();
#endif
            ...
            float nextDelay = this.m_regularDelay * (1 / m_dialogData.m_textSpeed);
            int skipCounter = 0;
            foreach (var symbol in textAsSymbolList)
            {
                ...
                if (symbol.IsTag)
                {
                    ...
                    if (symbol.Tag.TagType == VP_DialogSetup.Tags.DELAY)
                    {
                        ...
                        {
                            nextDelay = this.m_regularDelay * (1 / m_dialogData.m_textSpeed);
                        }
                        else
                        {
                            nextDelay = symbol.GetFloatParameter(this.m_regularDelay) * (1 / m_dialogData.m_textSpeed);
                        }
                    }
    ...
    [System.Serializable]
    public class VP_GraphicFadingDictionary : SerializableDictionaryBase<int, FadeUITime>
    {

    }

    [System.Serializable]
    public class VP_SerializedEmotions : RotaryHeart.Lib.SerializableDictionary.SerializableDictionaryBase<VP_DialogMessage.EMOTION, VP_DialogEmotionData>
    {

    }

    [System.Serializable]
    public class VP_SerializedDialogTypeSprites : RotaryHeart.Lib.SerializableDictionary.SerializableDictionaryBase<DIALOG_TYPE, Sprite>
    {

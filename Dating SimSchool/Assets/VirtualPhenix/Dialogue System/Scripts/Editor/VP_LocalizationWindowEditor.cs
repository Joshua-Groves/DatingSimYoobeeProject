...
{
    public class VP_LocalizationWindowEditor : EditorWindow
    {
        ...
        private static int m_screenshotID = 0;
        ...
        /// </summary>
        [MenuItem("Virtual Phenix/Localization Editor %F1")]
        ...
        private void OnGUI()
        {
            ...
            EditorGUILayout.HelpBox("This window will help you to localize easier than modifying files by hand", MessageType.Info);

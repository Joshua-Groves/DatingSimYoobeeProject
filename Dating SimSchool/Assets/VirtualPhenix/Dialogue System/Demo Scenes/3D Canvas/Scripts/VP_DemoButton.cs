...
namespace VirtualPhenix.Dialog.Demo
{
    public class VP_DemoButton : VP_DemoInteraction
    {
        ...
        {
            VP_DialogManager.ShowDirectMessage($"Click! The button is pressed, and this is a direct message instead of graph!",null, DIALOG_TYPE.REGULAR, false, false, true, m_message, null, null, () =>
            {
                VP_DialogManager.Instance.SetGlobalVariable("buttonPressed", m_activated);
